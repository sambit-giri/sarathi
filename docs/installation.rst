...
For a standard non-editable installation use::
    ...
    pip install git+https://github.com/sambit-giri/sarathi.git [--user]

The --user is optional and only required if you don't have write permission to your main python installation.
If you wants to work on the code, you can download it directly from the `GitHub <https://github.com/sambit-giri/sarathi>`_ page or clone the project using::

    git clone git://github.com/sambit-giri/sarathi.git

Then, you can just install in place without copying anything using::

    pip install -e /path/to/sarathi [--user]
