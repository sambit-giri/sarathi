...
Thank you so much for using ``sarathi``. Contributions are welcome and are greatly appreciated. 

Bug reports/Feedback/Questions
===============================================
It is very helpful to us when users report bugs or unexpected behaviour in the code. Please feel free to open an issue at the repository's `issue <https://github.com/sambit-giri/sarathi/issues>`_ page. It is also the best place to seek any help or would like to give us any feedback. 
